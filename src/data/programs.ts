...
import academicMain2 from '../assets/events/kempinski.jpeg';
...
export const programs: ProgramData[] = [
  {
    ...
    heroBadge: 'Education & Certification',
    detail: {
  ...
  },
  {
    ...
    icon: checkIcon,
    heroImage: checkHero,
    heroBadge: 'Verification & Compliance',
